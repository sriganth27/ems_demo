...
public class addEvent2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			try 
			{
				...
				ps1.setString(2, eventcategory);
				ps1.setString(3, eventdate);
				ps1.setString(4, eventtopic);
				ps1.setString(5, rpname);
				ps1.setString(6,  rpdetails );
				ps1.setString(7,imageFileName);
				ps1.setString(8,imageFileName2);
				ps1.setString(9, imageFileName3);
